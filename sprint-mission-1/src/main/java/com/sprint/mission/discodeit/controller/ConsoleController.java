            ...
            case "1" -> {
                while (true) {
                    ...
                    switch (serverInput) {
                        ...
                        case "6" -> {System.out.print("선택할 채널의 이름을 입력하세요: ");
                            String channelName = SC.next();
                            Channel channel = channelService.printChannel(channelName);
                         ...
                         숫자를 입력하세요:\s""");
                                ...
                                switch (userInput) {
                                    case "1" -> {
                                        ...
                                        userService.userCreate(userName, channel.getChannelName());
                                    }
                                    case "2" -> {
